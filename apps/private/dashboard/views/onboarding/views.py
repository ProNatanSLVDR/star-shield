...
def threshold_view(request):
    context = {
        ...
        "next_url": reverse("dashboard:onboarding:roulette"),
    }
...
def roulette_view(request):
    context = {
        ...
        "next_url": reverse("dashboard:onboarding:ai_responses"),
    }
    return starshield_render(request, "onboarding/roulette.html", context=context, page_name="onboarding")


@login_required
@check_onboarding_completed
def ai_responses_view(request):
    context = {
        "step": 5,
        "total_steps": 8,
        "prev_url": reverse("dashboard:onboarding:roulette"),
        "next_url": reverse("dashboard:onboarding:connect_google"),
    }
    return starshield_render(request, "onboarding/ai_responses.html", context=context, page_name="onboarding")
...
def connect_google_view(request):
    ...
    context = {
        "step": 6,
        "total_steps": 8,
        "prev_url": reverse("dashboard:onboarding:ai_responses"),
